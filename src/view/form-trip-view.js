...
import { OFFERS_ARRAY, OFFERS_BY_TYPE } from '../mock/offers.js';
import { DESTINATIONS } from '../mock/consts.js';

const createAvailableOffersTemplate = (offers, event) => {
  const availableOffers = OFFERS_BY_TYPE.find((el) => (el.type === event)).offers;
...
const createDescriptionTemplate = (destinations, name) => destinations.find((el) => el.name === name).description;

const createFormTripTemplate = (point) => {
    ...
    <section class="event__details">
      <section class="event__section  event__section--offers">
        ...
        <div class="event__available-offers">
          ${createAvailableOffersTemplate(OFFERS_ARRAY, type)}
        </div>
      </section>
      <section class="event__section  event__section--destination">
        <h3 class="event__section-title  event__section-title--destination">Destination</h3>
        <p class="event__destination-description">${createDescriptionTemplate(DESTINATIONS, name)}</p>
...
export default class FormTripView {
  constructor(point) {
    this.point = point;
  }

  getTemplate() {
    return createFormTripTemplate(this.point);
  }
